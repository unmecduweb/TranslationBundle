...
class XliffLoader implements LoaderInterface
{
    public function load($resource, $locale, $domain = 'messages')
    {
        ...
        $doc->registerXPathNamespace('LI', 'urn:LI:translation');

        $hasReferenceFiles = in_array('urn:LI:translation', $doc->getNamespaces(true));
        ...
        foreach ($doc->xpath('//xliff:trans-unit') as $trans) {
            ...
            if ($hasReferenceFiles) {
                foreach ($trans->xpath('./LI:reference-file') as $file) {
